...
@section('content')
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">LinkedIn Opt. Request Details</h5>
    ...
    <script>
        function loadDetails(request){
            var content = `
            LinkedIn Username: ${request.linkedin_username} <br><br>
            LinkedIn Password: ${request.linkedin_password} <br><br>

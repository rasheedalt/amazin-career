...
<div id="maincontent" class="m-2">
    ...
    @include('components.flash-message')
        <form method="post" action="{{ route('scholarship.post') }}">
            ...
            <textarea name="description" class="form-control" placeholder="About Scholarship" id="" cols="30" rows="10">{{ old('description') }}</textarea><br/>
            <textarea name="requirements" class="form-control" placeholder="Requirement/Qualifications" id="" cols="30" rows="10">{{ old('requirements') }}</textarea><br/>
            <textarea name="application_mode" class="form-control" placeholder="Method of Application" id="" cols="30" rows="10">{{ old('application_mode') }}</textarea><br/>

...
@section('content')
                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        @if($requests->count() > 0)
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="4" class="text-center">No request available</td></tr>
                        @endif
                        </tbody>
                        <tfoot>
                            {{ $requests->links() }}
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Business Plan Request Details</h5>
    ...
    <script>
        function loadDetails(request){
            ...
            Type of Business: ${request.type_of_business} <br><br>

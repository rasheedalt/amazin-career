<nav style="background-color: #F2EDED" class="navbar navbar-expand-lg navbar-light" >
    <a class="navbar-brand" href="/"><img class="" style="width: 190px;" src="{{ asset('/images/AmzinCareerBannerPNG.png') }}"   width="" alt="Amazin Careers"></a>
